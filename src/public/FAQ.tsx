...
const faqs: { q: string; a: string }[] = [
  {
    ...
    a: "A role-based job portal that uses AI-assisted features to improve job matching, recommendations, and profile management for employers and job seekers.",
  },
  {
    q: "Who can use the portal?",
    a: "Admins, employers, and job seekers — each role has its own dashboard and permissions.",
  },
  {
  ...
  },
  {
    ...
    a: "Register an account, complete your profile (or company profile for employers), and explore the dashboard and job listings.",
  },
  {
