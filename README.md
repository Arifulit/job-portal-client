...
A modern, enterprise-level job portal web application built with React, TypeScript, and TailwindCSS. Provides complete workflows for Job Seekers, Employers, and Admins with real-time updates, beautiful UI, and robust authentication.
...
1. **Job Seeker** - Browse jobs, apply, track applications
2. **Employer** - Post jobs, manage applicants, view analytics
